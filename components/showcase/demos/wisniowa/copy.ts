...
export const en = {
  ...
  quote: {
    text: "Good equipment can be bought in a week. Trust takes years to build and one visit to lose — which is why nobody here watches the clock.",
    name: "Dr A. Kowalska",
  ...
  about: {
    ...
    claims: [
      {
        text: "we’re a private practice and we don’t work under quota pressure — a visit lasts as long as it needs to, not as long as a billing code allows",
  ...
  gallery: [
    ...
    "We work under magnification and under the microscope — more precisely, with less risk of complications.",
  ...
  contact: {
    ...
    lead: "Call us, or leave a callback request — we get back to you the same working day.",
    ...
    note: "The address, directions and hours are illustrative — the brand is fictional. We deliberately leave out the building number: ul. Wiśniowa is a real street and we won’t send anyone to a real address.",
  },
...
export const pl: typeof en = {
  ...
  offer: {
    ...
    claims: [
      ...
      {
        text: "higienizację prowadzimy piaskiem na bazie erytrytolu, najdelikatniejszym z dostępnych — bez piekących dziąseł po wyjściu z fotela",
  ...
  about: {
    ...
    claims: [
      {
        text: "jesteśmy gabinetem prywatnym i nie pracujemy pod presją limitów — jedna wizyta trwa tyle, ile trzeba, a nie tyle, ile przewiduje rozliczenie",
  ...
  gallery: [
    ...
    "Pracujemy w powiększeniu i pod mikroskopem — dokładniej i z mniejszym ryzykiem powikłań.",
  ...
  promises: {
    ...
    items: [
      "Pierwsza wizyta może być samą rozmową. Nie musisz niczego decydować tego dnia.",
      ...
      "Nie proponujemy zabiegów, których sami nie zrobilibyśmy u siebie.",
    ],
  ...
  firstVisit: {
    ...
    lead: "Konsultacja trwa około 30 minut i kosztuje 150 zł. Poniżej jej pełna zawartość — żeby pierwsza wizyta nie była niespodzianką.",
    steps: [
      {
      ...
      },
      {
        ...
        body: "Sprawdzamy wszystkie zęby, dziąsła i zgryz. Zdjęcie RTG wykonujemy wtedy, gdy realnie zmienia plan leczenia — nie rutynowo.",
      },
      {
  ...
  contact: {
    ...
    lead: "Zadzwoń albo zostaw prośbę o kontakt — oddzwaniamy tego samego dnia roboczego.",
    labelAddress: "Adres",
    labelHours: "Godziny",
    ...
    travel: [
      ...
      { label: "Parking", body: "Strefa płatnego parkowania wzdłuż ulicy, dwa miejsca dla pacjentów od podwórza." },
      { label: "Wejście", body: "Parter, bez schodów i progów. Winda w budynku, toaleta dostępna dla wózków." },
    ],
    note: "Adres, dojazd i godziny są przykładowe — marka jest fikcyjna. Numeru budynku celowo nie podajemy: ul. Wiśniowa istnieje naprawdę i nie kierujemy nikogo pod prawdziwy adres.",
  },
