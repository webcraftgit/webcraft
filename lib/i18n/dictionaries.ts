...
export const en = {
  ...
  hero: {
    ...
    titleAccent: `sales`,
    titleEnd: `.`,
    subtitle: `We design, build and maintain digital experiences — from full websites to short-form content and brand assets — engineered to convert.`,
  ...
  services: {
    ...
    intro: `Four services, one standard — turn the wheel, one disc at a time.`,
    ...
    items: {
      sell: {
        ...
        body: `Custom-designed, hand-built sites structured around one job: turning visitors into inquiries.`,
      ...
      video: {
        ...
        body: `Reels and Shorts edited to hold attention in the first second — cut, captioned, paced for the feed.`,
  ...
  craft: {
    ...
    cards: {
      ...
      speed: {
        ...
        caption: `Watch a page load land under a second — the window where visitors decide to stay.`,
  ...
  showcase: {
    eyebrow: `Showcase`,
    heading: `Two demo sites, running live below.`,
    intro: `These aren't screenshots — both concept sites are rendering right now inside their frames. Click one to open it fullscreen, then scroll it, click around, and grab the 3D product with your cursor.`,
    footnote: `Both brands are fictional and built for demonstration. Your project gets the same treatment with your product at the center.`,
    live: `Live preview`,
    close: `Close`,
    openBadge: `Open fullscreen ↗`,
    playerCaption: `— concept site by Webcraft · scroll, click, drag the 3D`,
    openFullscreen: (name: string) => `Open the ${name} demo site fullscreen`,
    demoLabel: (name: string) => `${name} demo site`,
    demos: {
      blackwood: {
        blurb: `Speyside single malt distillery — concept site with a real-time 3D warehouse scene.`,
        facts: [`Concept site`, `Real-time 3D scene`],
      },
      wisniowa: {
        blurb: `A dental practice that reads like a quiet studio: warm off-white, editorial serif and a deep green that never raises its voice — built around a clearly-labelled booking prototype.`,
        facts: [`Booking prototype`, `Published price list`, `Warm clinical minimalism`],
      },
      nokturn: {
        blurb: `An alternative clothing label built as a working shop: variants, per-size stock, a real cart and offers that actually apply — wrapped in a deliberately quiet interface.`,
  ...
  process: {
    ...
    introPre: `Every project runs the same four steps — most go from brief to a live site in `,
    ...
    footnote: `Step times shown for a typical Business-scope build — Launch runs faster, Signature longer. Your quote comes with its own schedule.`,
    steps: {
      discover: {
        title: `Discover`,
        time: `2–3 days`,
  ...
  pricing: {
    ...
    footnote: `Every price above is a real starting point, not bait — the exact quote comes after a short discovery call, fixed before work starts, itemized so you can trim scope instead of quality. Founding-rate projects agree to let us publish the finished work as a case study.`,
    tiers: {
      launch: {
        name: `Launch`,
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: `We set up hosting and the domain as part of launch and hand you the keys — everything stays in accounts you own. After launch you can run it yourself, or keep us on the monthly care plan listed in the pricing section — hosting, updates, backups and small changes handled for you. Your call, no lock-in.`,
      },
      {
        q: `Is SEO included?`,
        a: `The technical side is built in on every project: fast loads, clean structure, proper metadata, sensible headings — the foundation search engines reward. Ongoing SEO campaigns and content strategy are a separate engagement, and we'll tell you honestly whether you need one.`,
      },
      {
      ...
      },
      {
        ...
        a: `About an hour for the discovery call, access to your brand materials if they exist, and honest answers about what the site should achieve. We draft structure and copy direction with you — you review at fixed checkpoints instead of writing pages yourself.`,
      },
    ],
  },
  contact: {
    ...
    submit: `Send it`,
    sending: `Sending…`,
    microcopy: `No newsletter, no follow-up sequence — one human reply.`,
  ...
  demos: {
    ...
    motion: {
      ...
      moves: {
        linear: {
          name: `Linear`,
          note: `Constant speed. Reads mechanical — how default sites move.`,
        },
        expo: {
          name: `Expo out`,
  ...
  consent: {
    ...
    necessaryDesc: `Remembers your language and this choice. Always on — the site cannot work without it.`,
...
export const pl: Dictionary = {
  ...
  hero: {
    ...
    titleEnd: `.`,
    subtitle: `Projektujemy, budujemy i utrzymujemy cyfrowe doświadczenia — od kompletnych stron po treści wideo i materiały brandingowe — zaprojektowane tak, by sprzedawać.`,
  ...
  services: {
    ...
    intro: `Cztery usługi, jeden standard — obracaj koło, dysk po dysku.`,
    ...
    items: {
      sell: {
        ...
        body: `Indywidualnie zaprojektowane i ręcznie zbudowane strony skupione na jednym zadaniu: zamianie odwiedzających w zapytania ofertowe.`,
        outcome: `Wyświetlenia → klienci`,
        /** Mobile disc copy. The circle cannot hold the full body at a
         *  readable size — see ServiceCard. Same promise, fewer words. */
        bodyShort: `Autorskie strony z jednym zadaniem: zamieniać odwiedzających w zapytania.`,
      },
      care: {
        title: `Opieka i utrzymanie`,
        body: `Aktualizacje, bezpieczeństwo, kopie zapasowe, monitoring dostępności i szybkości. Twoja strona zostaje w formie, gdy Ty prowadzisz biznes.`,
        outcome: `Zawsze dostępna, zawsze szybka`,
        /** Mobile disc copy. The circle cannot hold the full body at a
         *  readable size — see ServiceCard. Same promise, fewer words. */
        bodyShort: `Aktualizacje, bezpieczeństwo, kopie i monitoring — po naszej stronie.`,
      },
      video: {
        title: `Krótkie formy wideo`,
        body: `Reels i Shorts montowane tak, by przykuć uwagę w pierwszej sekundzie — cięte, z napisami, w rytmie social mediów.`,
        outcome: `Przewinięcia → wyświetlenia`,
        /** Mobile disc copy. The circle cannot hold the full body at a
         *  readable size — see ServiceCard. Same promise, fewer words. */
        bodyShort: `Reels i Shorts cięte tak, by trzymać uwagę od pierwszej sekundy.`,
      },
      print: {
  ...
  craft: {
    ...
    intro: `Cztery demo na żywo, zbudowane dokładnie tymi technikami, które wdrażamy u klientów. Przeciągaj, klikaj, odtwarzaj — wszystko poniżej to działający kod, a nie jego nagranie.`,
    cards: {
      resize: {
        title: `Płynne, nie ściśnięte`,
        caption: `Złap uchwyt. Układ się nie ściska — na każdej szerokości układa się od nowa.`,
        proof: `Jedna wersja, każdy ekran`,
      },
      theme: {
        title: `Każda marka, jeden system`,
        caption: `Kliknij próbkę. Każdy kolor i każde zaokrąglenie pochodzą z jednego zestawu tokenów — zmieniasz je raz.`,
        proof: `Twoja marka, co do piksela`,
      },
      speed: {
        title: `Szybkie tam, gdzie trzeba`,
        caption: `Zobacz, jak strona ładuje się w mniej niż sekundę — w chwili, w której odwiedzający decydują, czy zostać.`,
        proof: `Szybkość, która zatrzymuje`,
      },
      motion: {
        title: `Ruch z zamysłem`,
        caption: `Ten sam ruch, trzy temperamenty. To sposób wyhamowania ruchu sprawia, że niektóre strony sprawiają wrażenie drogich.`,
  ...
  showcase: {
    eyebrow: `Demo`,
    heading: `Dwie strony demo, działające na żywo poniżej.`,
    intro: `To nie zrzuty ekranu — obie koncepcyjne strony renderują się właśnie teraz w swoich ramkach. Kliknij jedną, by otworzyć ją na pełnym ekranie, a potem przewijaj, klikaj i chwyć produkt 3D kursorem.`,
    footnote: `Obie marki są fikcyjne i stworzone na potrzeby prezentacji. Twój projekt dostanie to samo podejście, z Twoim produktem w centrum.`,
    live: `Podgląd na żywo`,
    close: `Zamknij`,
    openBadge: `Otwórz pełny ekran ↗`,
    playerCaption: `— strona koncepcyjna od Webcraft · przewijaj, klikaj, przeciągaj 3D`,
    openFullscreen: (name: string) => `Otwórz stronę demo ${name} na pełnym ekranie`,
    demoLabel: (name: string) => `Strona demo ${name}`,
    demos: {
      blackwood: {
        blurb: `Destylarnia single malt ze Speyside — strona koncepcyjna ze sceną 3D magazynu w czasie rzeczywistym.`,
        facts: [`Strona koncepcyjna`, `Scena 3D w czasie rzeczywistym`],
      },
      wisniowa: {
        blurb: `Gabinet stomatologiczny poprowadzony jak spokojne studio: ciepła biel, szeryfowy krój i stonowana zieleń — z wyraźnie oznaczonym prototypem umawiania wizyt.`,
        facts: [`Prototyp rezerwacji`, `Jawny cennik`, `Ciepły, kliniczny minimalizm`],
      },
      nokturn: {
        blurb: `Marka odzieżowa zbudowana jak działający sklep: warianty, stany magazynowe na rozmiarach, prawdziwy koszyk i rabaty, które faktycznie się naliczają — w celowo spokojnym interfejsie.`,
  ...
  process: {
    ...
    introPre: `Każdy projekt przechodzi te same cztery kroki — większość trafia z briefu na żywą stronę w `,
    ...
    footnote: `Czasy kroków podane dla typowego projektu w zakresie Biznes — Start idzie szybciej, Premium dłużej. Twoja wycena ma własny harmonogram.`,
    steps: {
      discover: {
        title: `Analiza`,
        time: `2–3 dni`,
      ...
      launch: {
        ...
        deliverable: `Żywa strona + konfiguracja pomiarów`,
      },
    },
    funnel: {
  ...
  pricing: {
    ...
    introPre: `Jesteśmy nowym studiem — dokładnie widzisz, jak budujemy, na tej właśnie stronie, ale nie przewiniesz jeszcze dwudziestu case studies. Dlatego pierwszych `,
    introPost: ` klientów dostaje nasz pełny proces w stawkach, których nigdy więcej nie zaproponujemy. Wraz z portfolio rosną też ceny.`,
    from: `od`,
    upToPre: `zwykle do`,
    ...
    tiers: {
      launch: {
        ...
        includes: [
          ...
          `Formularz/pozyskiwanie leadów podłączone do Twojej skrzynki`,
    ...
    split: `Płatność w 2 ratach — 50% na początek, 50% przy uruchomieniu`,
    care: {
      ...
      includes: [
        ...
        `Drobne zmiany co miesiąc — teksty, zdjęcia, ceny (do ~1h)`,
      ],
  ...
  faq: {
    eyebrow: `FAQ`,
    heading: `Pytania, które każdy klient zadaje najpierw.`,
    ...
    items: [
      ...
      },
      {
        ...
        a: `Publikowane punkty startowe są tuż wyżej, w sekcji cennika — obecnie w stawkach założycielskich, póki nasze portfolio się zapełnia. Dokładną kwotę ustalamy po krótkiej rozmowie wstępnej, przed rozpoczęciem prac, a wycena jest rozpisana pozycjami, żebyś mógł ciąć zakres, a nie jakość. Bez niespodzianek godzinowych.`,
      },
      {
        q: `Dlaczego to kosztuje więcej niż strony za 3 000 zł, które widziałem?`,
        a: `Bo to inny produkt. Większość tanich ofert to gotowy szablon z podmienionym logo i tekstem — szybko i w porządku, jeśli tyle Ci wystarczy. To, co widzisz na tej stronie, jest autorskie: układ, ruch, 3D i całą ścieżkę klienta projektujemy wokół Twojego biznesu, a nie wokół motywu. To wymaga realnej pracy projektowej i programistycznej — i za nią płacisz. Jeśli szablon naprawdę jest dla Ciebie właściwym wyborem, powiemy to wprost — i wskażemy coś tańszego, zamiast sprzedawać Ci coś, czego nie potrzebujesz.`,
      },
      {
        q: `Czy mogę zapłacić w ratach?`,
        a: `Tak — każdy projekt domyślnie dzielimy na 50% na początek i 50% przy uruchomieniu, więc nigdy nie płacisz całości z góry, a druga część staje się wymagalna dopiero, gdy strona jest gotowa do publikacji. Przy większych projektach Premium możemy rozbić to na więcej etapów. Bez finansowania, bez odsetek — po prostu praca podzielona na etapy.`,
      },
      {
        q: `Czy będę mógł samodzielnie edytować stronę?`,
        a: `Tak. Treści, które ruszasz często — teksty, zdjęcia, oferty — podłączamy do panelu edycji, którego użyjesz bez nas. Elementy, które trzymają stronę szybką i dopracowaną, zostają w kodzie, żeby projekt nie rozjechał się po przekazaniu.`,
      },
      {
        q: `Czy zajmujecie się hostingiem, domenami i utrzymaniem?`,
        a: `Hosting i domenę ustawiamy w ramach startu i przekazujemy Ci klucze — wszystko zostaje na kontach, które należą do Ciebie. Po starcie możesz prowadzić stronę sam albo skorzystać z miesięcznej opieki nad stroną z sekcji cennika — hosting, aktualizacje, kopie zapasowe i drobne zmiany po naszej stronie. Twój wybór, bez przywiązywania Cię do nas na siłę.`,
      },
      {
        q: `Czy SEO jest w cenie?`,
        a: `Strona techniczna jest wbudowana w każdy projekt: szybkie ładowanie, czysta struktura, poprawne metadane, sensowne nagłówki — fundament, który doceniają wyszukiwarki. Bieżące kampanie SEO i strategia treści to osobna współpraca, a my uczciwie powiemy, czy jej potrzebujesz.`,
      },
      {
        q: `Czy możecie przerobić naszą obecną stronę zamiast robić ją od zera?`,
        a: `Czasem — jeśli struktura pod spodem jest zdrowa, przeprojektowanie na jej bazie jest tańszą drogą i powiemy to wprost. Jeśli problemem jest sam fundament, łatanie kosztuje więcej niż budowa od nowa. Najpierw robimy audyt i rekomendujemy to, co faktycznie tańsze dla efektu, którego chcesz.`,
      },
      {
        q: `Czego potrzebujecie od nas, żeby zacząć?`,
        a: `Około godziny na rozmowę wstępną, dostęp do materiałów marki, jeśli je macie, i szczere odpowiedzi na pytanie, co strona ma osiągnąć. Szkic struktury i kierunek treści tworzymy z Tobą — recenzujesz w ustalonych punktach kontrolnych, zamiast pisać strony samodzielnie.`,
      },
    ],
  },
  contact: {
    ...
    submit: `Wyślij`,
    sending: `Wysyłanie…`,
    microcopy: `Bez newslettera, bez sekwencji follow-up — jedna ludzka odpowiedź.`,
  ...
  demos: {
    ...
    motion: {
      ...
      moves: {
        linear: {
          name: `Liniowy`,
          note: `Stała prędkość. Wygląda mechanicznie — tak porusza się domyślna strona.`,
        },
        expo: {
          name: `Wykładniczy`,
  ...
  notFound: {
    eyebrow: `Błąd 404`,
    heading: `Ta strona skręciła w złą stronę.`,
    body: `Link jest nieprawidłowy albo strona została przeniesiona. Wszystko, co ważne, jest o jedno przewinięcie stąd — na stronie głównej.`,
  ...
  consent: {
    ...
    necessaryDesc: `Zapamiętują język i ten wybór. Zawsze włączone — bez nich strona nie zadziała.`,
